...
// Styled components for the button variations
const StyledButton = styled.button<{
  ...
  font-family: inherit; // Assuming text-body-01-emphasis sets the font
  font-size: inherit; // Ensure it matches the body emphasis from your CSS
